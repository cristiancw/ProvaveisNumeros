...
/**
 * Representa a configuração para executar o cálculo, definindo os filtros necessários e a frequência escolhida.
 * 
 * @author Cristian
 */
public class Configuracao {
	...
	public boolean isValido() {
		...
		if (frequencia == null) {
			...
			isValido = false;
			motivoInvalido = "O número inicial do concurso não pode ser maior que o número final.";
		}
		return isValido;
	}
