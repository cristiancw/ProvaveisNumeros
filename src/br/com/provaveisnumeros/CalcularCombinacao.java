...
/**
 * Com a lista de números possíveis calcula todas a combinações de resultados que eles podem gerar.
 * 
 * @author Cristiancw
 */
class CalcularCombinacao {
	...
	/**
	 * Calcula as combinações possíveis utilizando os números passados.
	 * 
	 * @param frequentes
